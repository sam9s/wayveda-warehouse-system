...
- Fixed the KPI-summary mapping bug where Postgres lowercased unquoted aliases and the frontend therefore received zeroed summary values despite real underlying data.
